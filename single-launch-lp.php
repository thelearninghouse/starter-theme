...
<html <?php language_attributes(); ?>>
	...
	<head>
		...
		<style>
			...
			#form {
				background-color: <?php echo ( 'custom' === $form_style['color'] ? $form_style['color_custom'] : ( 'primary' === $form_style['color'] ? $color_1 : $color_2 ) ); ?>;
			}

			#value-props .value-prop {
				background-color: <?php echo ( 'custom' === $values_style['color'] ? $values_style['color_custom'] : ( 'primary' === $values_style['color'] ? $color_1 : $color_2 ) ); ?>;
			}

			#about {
				background-color: <?php echo ( 'custom' === $about_style['color'] ? $about_style['color_custom'] : ( 'primary' === $about_style['color'] ? $color_1 : $color_2 ) ); ?>;
			}

			#cta .button {
				background-color: <?php echo ( 'custom' === $cta_button_style['color'] ? $cta_button_style['color_custom'] : ( 'primary' === $cta_button_style['color'] ? $color_1 : $color_2 ) ); ?>;
			}
		</style>
				...
				<?php if ( get_field( 'lp_accreditation_title' ) ) { ?>
					<section id="accreditation">
						<div class="wrap">
							...
							<?php
							$images   = get_field( 'lp_accreditation_logos' );
