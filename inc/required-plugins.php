...
add_action( 'tgmpa_register', 'tlh_register_required_plugins' );
 ...
 */
function tlh_register_required_plugins() {
	/*
	 * Array of plugin arrays. Required keys are name and slug.
	 * If the source is NOT from the .org repo, then source is also required.
	 */
	$plugins = json_decode( file_get_contents( get_theme_file_path( '/wp-plugins.json' ) ), true );
