<footer class="footerMag" itemscope itemtype="http://schema.org/WPFooter">
	...
	<div class="footerMag__copyright">
		<p class="wrapLg"><span class="footerMag__copyright-text">&copy; <?php echo date('Y'); ?> <?php the_field('school_name', 'options'); ?></span> <a class="footerMag__privacy" href="/privacy-policy" title="View our privacy policy">Privacy Policy</a></p>
	</div>
