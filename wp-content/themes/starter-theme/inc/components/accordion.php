    ...
    { ?>
      <dl id="accordion-<?php echo $accord_id; ?>" role="presentation" class="accordion<?php echo $class ? ' ' . $class : ''; ?>" data-allow-toggle=""<?php echo $allow_multiple ? ' data-allow-multiple=""' : ''; ?><?php echo $first_open ? ' data-first-open=""' : ''; ?>>
        ...
        <dt role="heading" aria-level="3">
          <button aria-expanded="false" class="accordion__trigger" aria-controls="sect<?php echo $i; ?>" id="accordion-<?php echo $accord_id; ?>-header-<?php echo $i; ?>" type="button">
        ...
        <dd id="sect<?php echo $i; ?>"
          role="region"
          aria-labelledby="accordion-<?php echo $accord_id; ?>-header-<?php echo $i; ?>"
