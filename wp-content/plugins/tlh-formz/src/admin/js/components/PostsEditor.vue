<template>
  <v-card>
        ...
        <v-card-title primary-title>
          ...
          <div id="cpt-menu-wrapper">
            <v-menu attach :nudgeBottom="35" transition="slide-y-transition" bottom>
              ...
              <v-list>
                <v-list-tile v-for="(postType, key) in customPostTypes" :key="key" @click="editList = customPostTypes[key]">
        ...
        <bulk-edit-stepper @stepper-cancel="closeDialog('bulkEditDialog')" @stepper-save="bulkUpdate">
          ...
          <v-list subheader slot="step1">
            ...
            <v-list-tile>
              ...
              <v-list-tile-content @click="bulkEditOptions.scriptType = !bulkEditOptions.scriptType">
            ...
            <v-list-tile>
              ...
              <v-list-tile-content @click="bulkEditOptions.partnershipId = !bulkEditOptions.partnershipId">
                <v-list-tile-title>Partnership ID</v-list-tile-title>
              </v-list-tile-content>
            </v-list-tile>
          </v-list>

          <FormListEditor two-line subheader slot="step2" :fieldVisibility="bulkEditOptions" :updatedFormObject="bulkEditObject" v-if="bulkEditOptions.showForm || bulkEditOptions.formName" />
        </bulk-edit-stepper>
      </v-dialog>
    ...
    <v-snackbar v-model="updatedSnackbar" :bottom="true" :timeout="2000">
      Updated!
    </v-snackbar>
  </v-card>
</template>
