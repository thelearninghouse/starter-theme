...
if(!$sk_parallax_home_IDs['selectedLandingPage']){
	echo 'Invalid parallax page ID. Check plugin options';
	exit();
}		

$gravity_engine = new GravityFrontEngine($sk_parallax_home_IDs['selectedLandingPage']);
  		...
  		<div id="menuContainer" class="<?php echo ($gravity_engine->isMobile())?'':'invisibleMenu';?>">
		  	...
		  	<div class="container">
		  		<div class="row">
			  		...
			  		<?php endif;?>
			  		<!--/if page logo-->			  			  			
				  		<div id="gravityMenuUI" class="<?php echo ($gravity_engine->isPageLogo())?"gravityMenuUIWithLogo":"";?>">
